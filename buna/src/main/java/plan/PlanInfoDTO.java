...
public class PlanInfoDTO {
	...
	public Timestamp getP_firstdate() {
		return p_firstdate;
	}
	public void setP_firstdate(Timestamp p_firstdate) {
		this.p_firstdate = p_firstdate;
	}
	public Timestamp getP_lastdate() {
		return p_lastdate;
	}
	public void setP_lastdate(Timestamp p_lastdate) {
