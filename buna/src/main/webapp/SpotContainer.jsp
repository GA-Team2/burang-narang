<%@page import="org.ga2.buna.dto.Restaurant"%> <%@page
import="org.ga2.buna.dao.RestaurantDAO"%> <%@page
import="org.ga2.buna.dto.SpotDetail"%> <%@page import="java.util.ArrayList"%>
<%@page import="org.ga2.buna.dao.SpotDetailDAO"%> <%@ page language="java"
