...
function make_plan() {
  ...
  document
    .querySelector("input[name='p_firstdate']")
    .setAttribute("value", first);
  document
    .querySelector("input[name='p_lastdate']")
    .setAttribute("value", last);
  document
    .querySelector("input[name='t_namelist']")
    .setAttribute("value", taglist);
