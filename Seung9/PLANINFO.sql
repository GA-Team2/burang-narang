...
rollback;
INSERT INTO PLANINFO_TEST VALUES(5, 'gk', '절거운 부산 여행', '2022-08-11', '2022-08-13', '#바다 #해운대 #조개구이 #먹고싶다', sysdate, '1');
INSERT INTO PLANINFO_TEST VALUES(4, 'gk', '행복한 부산 여행', '2022-11-10', '2022-11-10', '#어쩌구 #저쩌구 #맛집 #숙소 #카페', sysdate, '20');
insert into planinfo_test values(4,'g','g','2022-08-11','2022-08-12','#e',sysdate,40);
INSERT INTO PLANINFO_TEST VALUES(1, 'gk', '절거운 부산 여행', '2022-08-11', '2022-08-13', '#바다 #해운대 #조개구이 #먹고싶다', sysdate, '10');
INSERT INTO PLANINFO_TEST VALUES(2, 'gk', '행복한 부산 여행', '2022-11-10', '2022-11-10', '#어쩌구 #저쩌구 #맛집 #숙소 #카페', sysdate, '20');
INSERT INTO PLANINFO_TEST VALUES(3, '하', '재밌는 부산 여행', '2022-11-22', '2022-11-24', '#부산 #산 #바다', sysdate, '30');
