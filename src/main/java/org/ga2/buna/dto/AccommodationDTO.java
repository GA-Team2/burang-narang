...
public class AccommodationDTO {
	...
	public String getA_pnumber() {
		return a_pnumber;
	}
	public void setA_pnumber(String a_pnumber) {
		this.a_pnumber = a_pnumber;
	}
	...
	public void setA_checkin(String a_checkin) {
		this.a_checkin = a_checkin;
	}
