<%@page import="org.ga2.buna.dao.spotdetail.SpotDetailDAO"%>
<%@page import="org.ga2.buna.dao.spotdetail.SpotDetailDAO"%>
<%@page import="org.ga2.buna.dto.spotdetail.SpotDetailDTO"%>
...
<%
	...
	for (int i = 0; i < spList.size(); i++) {
		...
		if (sCode == 'T')
			tfList.add(tfDAO.getTraffic(sNum));
		else if (sCode == 'A')
			acList.add(acDAO.getAccommodation(sNum));
		else if (sCode == 'R')
			reList.add(reDAO.getRestaurant(sNum));
		else if (sCode == 'E')
			evList.add(evDAO.getEvent(sNum));
	}
	%>
	<div class="spot_list">
		<%
