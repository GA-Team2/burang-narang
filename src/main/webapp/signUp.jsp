      ...
      <div class="signUpBox">
        ...
        <form name="signUp" method="post" action="signUpOk.jsp">
          ...
          <div class="nicknameBox">
            ...
            <input type="text" name="MNickname" id="MNickname" value="<% if(nickR != null){out.print(nickR);}%>" placeholder="닉네임은 최대 6자까지 가능합니다."/>
            <!-- 중복체크 버튼 -->
          ...
          <div class="pwdBox">
            <p>비밀번호</p>
            <!-- 비밀번호 input -->
            <input type="password" name="MPassword" id="MPassword" placeholder="비밀번호는 영문자/특수문자를 포함한 8글자 이상이어야 합니다." />
            <!-- 비밀번호 미입력 시 경고문  -->
          ...
          <div class="birthBox">
            <p>탄생년도</p>
            <!-- 탄생년도 input -->
            <input type="text" name="MBirthday" id="MBirthday" placeholder="년도만 써주세요" />
            <!-- 탄생년도 미입력 시 경고문 -->
          ...
          <div class="genderBox">
          	   <!-- 남성 선택 radio(value를 1로 설정해서 boolean 기능으로 사용) -->
		            남성<input type="radio" name="MGender" id="man" value="1" />
          	   <!-- 여성 선택 radio(value를 0로 설정해서 boolean 기능으로 사용) -->
		            여성<input type="radio" name="MGender" id="woman" value="0" />
		    <!-- 성별 미선택 시 경고문 -->
